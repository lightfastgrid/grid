/**
 * Framework-neutral benchmark modules. Vanilla apps must import this subpath
 * so the production bundle never pulls React components from the shared entry.
 */
export type {
  BenchmarkLane,
  BenchmarkRow,
